...
class CensusDataFetcher:
    ...
    def fetch_pep_state_data(
        ...
        response = self._make_request(
            url,
            params,
            f"PEP state data (vintage {vintage})"
        )
    ...
    def fetch_pep_county_data(
        ...
        response = self._make_request(
            url,
            params,
            f"PEP county data (vintage {vintage})"
        )
    ...
    def fetch_acs_place_data(
        ...
        response = self._make_request(
            url,
            params,
            f"ACS {dataset} place data (year {year})"
        )
    ...
    def fetch_pep_by_file(
        ...
        response = self._make_request(
            file_url,
            description=f"PEP file download ({geography}, vintage {vintage})"
        )

...
**Status:** Core projection development complete; PP-001 publication sign-off and PP-002 cadence closeout completed on 2026-03-01; PP-005 Phase 2+ enhancements implemented (rolling-origin backtests, multi-county splitting, TIGER/geospatial exports, housing-unit method); PP-007 Projection Observatory operational hardening completed on 2026-03-13; PUB-2026 public-release handoff to marketing active as of 2026-05-27.
...
| Test health baseline | stable | Latest recorded baseline: `2184 passed, 6 skipped` (`pytest tests/ -q -rs`, 2026-03-19) with no warnings after evaluation warning cleanup, geospatial dependency enablement, shapefile export warning suppression, and restoration of the optional `sdc_2024_replication` sibling-repo test surface. The pre-commit fast gate is now optimized for edit loops via `pytest-xdist` plus `--no-cov`, and the default coverage-bearing pytest path now runs in parallel while leaving HTML coverage generation opt-in. ADR-056 accepted; PP4-01 through PP4-06 complete; PP-005 adds 129 tests; BM-001 adds 42 tests. |
| Claim replay health | stable | `27/27` adjudicated claims passing (latest full replay: 2026-02-27T18:14:03Z). |
| Projection Observatory readiness | stable | OBS-01 through OBS-09 complete. Bounded unattended queueing (PP-007), deterministic autonomous search sandbox (PP-008), longitudinal history dashboard (PP-009), and 2026-03-18 guided decision-brief / benchmark-blocker UX improvements implemented. 2026-03-19 follow-up UX fixes added a junior-demographer persona reference, wired a real guided-review entry path from completed search sessions, corrected stale completion guidance, added a portrait-oriented stacked review flow tuned to the workstation's `1440x2560` portrait monitor, then implemented a first-run local-workstation readiness preflight plus canonical workspace-state routing for `Get Ready`, `Start First Exploration`, `Review Best Candidate`, `Prepare Recommendation`, and recovery paths, promoted operational-quality evidence from passive tracking into active decision gating so incomplete bundles block review, runtime/reproducibility warnings force review, and recommendation readiness now requires operationally clean benchmark evidence, and closed the remaining SOP-003 convenience layer by adding alias-aligned `benchmark_history/latest/` pointer refresh plus history smoke-test coverage proving canonical dated bundles remain untouched. 2026-03-21 follow-up hardening introduced first-class deep search: one-click CPU-budget-driven dashboard launch, `deep-search` CLI plus backward-compatible `search-auto`, CF-001 search packs, collision-resistant benchmark `run_id`s, shared CPU allocation policy, append-only search journaling/quarantine, deterministic Deep Search Brief artifacts/frontier summaries, and optional claim-checked AI synthesis scaffolding. See PP-007/PP-008/PP-009 rows and detail sections below for specifics. |
| Public projection handoff | active | PUB-2026 opened on 2026-05-27 for marketing intake and public PDF/download planning. ADR-065 now defines the public path as Baseline (CBO-Adjusted), with the CBO additive migration adjustment and -5% fertility adjustment embedded in `baseline`. ADR-066 updates the production base to Census PEP Vintage 2025 county totals (`POPESTIMATE2025`, state total 799,358). Public scope remains state/region/county only, no city/place publication, and one consolidated public Excel plus one consolidated CSV. Existing March 2026 draft numbers/assets are stale for final copy; final numbers are targeted for the week of 2026-06-01 after CF-001 disposition and the ADR-065/066 baseline production rerun passes QA. **2026-06-13: numbers final/locked** — CF-001 disposed, locked-config rerun + Stage 4 validation + Stage 5 package/QA complete; awaiting marketing layout and publication. |

## Projection Development Backlog (Canonical)

| ID | Work Item | Status | Next Milestone | Source |
|------|------|------|------|------|
| PP-001 | Publication-facing output QA and dissemination packaging | completed_2026-03-01 | Closed: owner sign-off recorded for 2026-03-01 package set; stakeholder feedback incorporation explicitly deferred to later cycle | `docs/reviews/audit/2026-03-01-publication-output-signoff.md`, `docs/reviews/repo-hygiene-audit/implementation/31-pp001-signoff-pp002-closeout-results.md` |
...
| PP-003 | City/place projection workstream reactivation (ADR-033) | completed_2026-03-01 | Closed after IMP-21 methodology finalization consistency and IMP-22 tracker closeout confirmation | `docs/plans/pp3-s08-implementation-kickoff.md`, `docs/reviews/analysis/2026-02-28-pp3-s07-approval-gate.md`, `docs/reviews/benchmarking/2026-02-28-pp3-imp09-backtest-results.md`, `docs/reviews/analysis/pp3-backtest-outlier-narrative.md`, `docs/reviews/benchmarking/2026-03-01-pp3-imp11-pipeline-stage-results.md`, `docs/reviews/benchmarking/2026-03-01-pp3-imp12-imp13-results.md`, `docs/reviews/benchmarking/2026-03-01-pp3-imp12-imp13-approval-gate.md`, `docs/reviews/benchmarking/2026-03-01-pp3-imp13a-results.md`, `docs/reviews/benchmarking/2026-03-01-pp3-imp14-results.md`, `docs/reviews/benchmarking/2026-03-01-pp3-imp15-results.md`, `docs/reviews/benchmarking/2026-03-01-pp3-imp16-results.md`, `docs/reviews/benchmarking/2026-03-01-pp3-imp17-imp18-results.md`, `docs/reviews/analysis/pp3-end-to-end-validation.md`, `docs/reviews/benchmarking/2026-03-01-pp3-imp19-approval-gate.md`, `docs/reviews/analysis/2026-03-01-pp3-imp20-results.md`, `docs/reviews/analysis/2026-03-01-pp3-imp21-methodology-finalization-consistency-results.md`, `docs/reviews/analysis/2026-03-01-pp3-imp22-tracker-closeout-results.md`, `docs/governance/adrs/033-city-level-projection-methodology.md` |
| PP-004 | Test coverage gap closure (ADR-056) | completed_2026-02-28 | Closed: PP4-01 through PP4-06 complete; periodic coverage checks now roll into future PP-002-style cadence events when material changes occur | `docs/governance/adrs/056-testing-strategy-maturation.md`, `docs/guides/test-maintenance-practices.md`, `docs/reviews/analysis/2026-02-28-pp4-06-periodic-coverage-review.md` |
...
| PP-007 | Projection Observatory operational hardening | completed_2026-03-13 | Closed: OBS-01 through OBS-09 complete. Bounded unattended queueing with resume/budget/retry controls, normalized artifacts, and SOP-003-aligned operator guide. | `scripts/analysis/observatory.py`, `cohort_projections/analysis/observatory/`, `config/observatory_variants.yaml`, `data/analysis/benchmark_history/`, `data/analysis/experiments/experiment_log.csv`, `docs/guides/observatory-search-loop.md` |
| PP-008 | Deterministic autonomous search sandbox | completed_2026-03-15 | Deterministic search via bare-mirror worktrees with protected-path policy, recipe catalog, patch harvesting, and CLI (`search-plan`/`search-run`/`search-status`/`search-report`/`search-auto`, plus first-class `deep-search` as of 2026-03-21). No auto-promotion. See details below. | `scripts/analysis/observatory.py`, `cohort_projections/analysis/observatory/search_controller.py`, `cohort_projections/analysis/observatory/sandbox_manager.py`, `cohort_projections/analysis/observatory/recipe_registry.py`, `cohort_projections/analysis/observatory/deep_search.py`, `cohort_projections/analysis/observatory/ai_synthesis.py`, `config/observatory_search_policy.yaml`, `config/observatory_search_packs/`, `config/observatory_recipes.yaml`, `docs/guides/observatory-autonomous-search.md`, `scripts/analysis/run_benchmark_suite.py`, `scripts/analysis/run_experiment.py`, `scripts/analysis/walk_forward_validation.py`, `cohort_projections/analysis/observatory/dashboard/data_manager.py`, `cohort_projections/analysis/observatory/dashboard/tab_command_center.py` |
| PP-009 | Longitudinal benchmark-history dashboard | completed_2026-03-15 | Completed `P4` from the benchmarking roadmap by adding a dedicated `History` tab to the Projection Observatory dashboard. The tab turns the benchmark archive into a first-class decision surface with full run timeline tables, champion-at-run history, metric delta heatmaps, category-level trend charts, and accepted/rejected challenger history over time. | `cohort_projections/analysis/observatory/dashboard/app.py`, `cohort_projections/analysis/observatory/dashboard/data_manager.py`, `cohort_projections/analysis/observatory/dashboard/tab_history.py`, `tests/test_analysis/test_observatory_dashboard.py`, `docs/plans/benchmarking-process-improvement-roadmap.md`, `docs/guides/observatory-start-here.md` |
| CF-001 | College Fix model revision (m2026r1) | complete | Tier-3 disposition 2026-06-11: ADR-061 Accepted as modified (D1 accepted; D2 accepted with GQ fraction calibrated to 0.75; D3 rejected for the 2026 release; D4 accepted minus Williams per ADR-067). Promoted `m2026r1`/`cfg-20260611-production-lock` to `county_champion` via SOP-003 tooling with Approved decision record. ADR-067 investigation corrected a walk-forward evidence-integrity defect (all pre-2026-06-11 bundles contaminated); authoritative evidence is the 2026-06-11 raw-base matrix incl. `rawbase-production-lock`. Pending: locked-config production rerun (PUB-2026 Stage 3). | ADR-061, ADR-067, `docs/reviews/benchmark_decisions/2026-03-09-m2026r1-vs-m2026.md`, `docs/governance/sops/SOP-003-method-benchmarking-versioning-promotion.md` |
| PUB-2026 | Public projection release handoff to marketing | active | Marketing intake begins 2026-05-27. ADR-065 accepted: public release is baseline-only with CBO-adjusted assumptions in `baseline`; `recent_trend_continuation`, `restricted_growth`, and `high_growth` are inactive/internal. ADR-066 accepted: production base-population totals now use Census PEP Vintage 2025 `CO-EST2025-ALLDATA` (`POPESTIMATE2025`; North Dakota total 799,358) rather than the stale legacy 2024 county CSV. **Update 2026-06-13:** CF-001 disposed (ADR-061 Accepted-as-modified; ADR-067 Williams removal); locked-config production rerun complete (`m2026r1`/`cfg-20260611-production-lock`, commit `12fa6f9`; state 799,358 → 889,017, +11.2%, trough 787,382 @2028 — **superseded, see Update 2026-06-16**). Stage 4 validation PASS (sanity check + Gate 1b) with Ward/GF/Williams divergences dispositioned and user-signed-off. Stage 5 public package rebuilt (workbook incl. new State Age-Sex Detail sheet, 1,922-row CSV, refreshed PDF copy + charts) and release QA executed gate-by-gate (`docs/reviews/audit/2026-06-13-release-qa-signoff.md`). **Update 2026-06-16 (ADR-068):** the 2026-06-13 run carried a ~3x `reference_intl_migration` error plus an open-ended 90+ survival error and (in the 2026-06-15 amendment) a survival-table horizon truncation; all three corrected and the full-horizon production rerun re-locked (config sha `a6e0bfbc2d70be85`; state 799,358 → shallow trough **797,298 @2027 (−0.26%)** → **898,907 @2055 (+12.45%)**, 90+ @2055 8,172). Artifacts, methodology, SDC-comparison doc, and public package re-synced; ADR-068 amendment adds survival- and migration-horizon coverage guards (PRs #25/#26 merged). **Update 2026-07-07 (PUB-2026-ERRATA executed):** pre-handoff assessment + release-machine verification fixed the stale declining-county count (37→**36**), reworded the track-record claim (attributed 793,537 vs 779,094 ≈2%), fixed pyramid/workbook label code, added the 2024-edition comparison box + series-convention cover (I1), the components-of-change exhibit (I2), and the methods-companion docx (I4), and extended the `--strict` prose-sync gate (I6); F4-RESYNC consciously deferred; F7 re-review deferred; package + 7 docx regenerated. Remaining: **owner** manual IT-sanctioned backup (bisync disabled per IT policy; this machine holds the sole copy of corrected outputs), then marketing layout, contact/download placeholders, and publication. Public package excludes city/place projections and uses consolidated Excel/CSV downloads. | `docs/plans/2026-public-projection-release-handoff/`, ADR-065, ADR-066, ADR-042, ADR-038, ADR-067, CF-001 |
| F4-RESYNC | ADR-067 F4 decomposition reproducibility + re-run vs corrected baseline | open | The F4 forward-decomposition figures (CBO-mig −23k @2050 etc.) went stale after ADR-068 and are hand-copied across ~7 places in 3 docs; methodology-comparison §4.2 was caveated in PR #27. Only the CBO-migration lever actually changed (scales with the 3×-corrected `ref_intl`, ~+23k→~+7.6k est.); fertility/GQ/D3 are ADR-068-independent. Re-run procedure (projection-stage CBO/fertility = safe/isolated; D3/GQ = upstream regen that clobbers production `data/processed/` → needs backup-restore), brittleness diagnosis, and improvement options (committed harness / upstream output-isolation / single-source CSV + staleness tripwire / checklist hook) are documented. **Decision 2026-07-07: consciously deferred for the 2026 release** — the caveated stale figures stand (internal decomposition detail, already flagged in `methodology_comparison_sdc_2024.md` §4.2 with the re-run pointer; the re-run would clobber production `data/processed/`). Revisit next vintage. Recorded in the release-readiness checklist §1 and the handoff decision log. | `docs/plans/f4-decomposition-reproducibility.md`, ADR-067, `docs/reviews/analysis/2026-06-12-adr-065-defensibility-memo.md` |
| PRIMARY-RECOVERY | Primary-machine data-loss disposition (2026-07 incident; ~85% recovery odds per owner) | open | If recovery succeeds: bisync push from primary (verify stale `2025_2045` cleanup propagates), pull elsewhere — runbook §6. If it fails: execute runbook §4 (sandboxed stage-02 regen on the WSL machine, byte-verify vs the git-tracked locked CSV, promote, push) + §5 Tier-2 dispositions (record benchmark-evidence loss; F4 folded into F4-RESYNC). Either way: §7 systemic follow-ups (add `data/analysis/benchmark_history` to the bisync filter; backfill raw `CO-EST2025-ALLDATA` to Drive). Verified 2026-07-06: all locked stage-01 inputs are safe on Drive + WSL; only stage-02 outputs and `data/analysis` evidence are primary-only. | `docs/plans/primary-machine-data-loss-regeneration-runbook.md` |
| PUB-2026-ERRATA | Pre-handoff errata + assessment follow-ups (2026-07-06 draft-materials review vs 2024 SDC report) | closed_2026-07-07 | **Executed 2026-07-07** (owner-approved; see the ship-readiness verification doc for the disposition record): F1 declining-county count corrected to **36** in all public prose + regenerated docx; F2 track-record claim reworded to the attributed 793,537-vs-779,094 (≈2%) figures — 2018 publication unlocatable online, so the 2024 edition's printed projection value is quoted with a re-verify note; F3 label fixes in `visualizations.py` (open-ended "90+", int age labels) and `build_public_draft_package.py` (`.clip(upper=85)` in chart-pyramid bins); F4 resolved — this machine IS the primary and holds all inputs, package regenerated here (bisync retired per IT policy); F5 front-door README rewritten + snapshot/intake-brief bannered + decision log appended; I6 `_check_prose_sync` extended (declining count, five county callouts, top-3 share band, 2024-comparison values, explainer coverage). Content upgrades adopted: **I1** (2024-comparison box + series title convention), **I2** (components-of-change exhibit: `Chart - Components` sheet + `chart_components_change.png` + PDF-copy section — which also caught and fixed a wrong "migration recovers to positive" sentence), **I4** (explainer = 7th generated docx). Declined/deferred: I3 (region key-year table), I5 (PDF-copy prose pass), I7 (downgraded to an axis-annotation handoff note), I8 (CSV precision — full-precision floats stand, documented), I9 (next vintage). | `docs/reviews/audit/2026-07-06-pub-2026-draft-materials-assessment.md`, `docs/reviews/audit/2026-07-06-pub-2026-ship-readiness-verification.md` |

### PP-008 Detail

Incremental follow-ups on 2026-03-15:

- Wired search-only method cloning into benchmark runtime so recipe candidates can benchmark sandbox-only method IDs without mutating production aliases
- Added `search-auto` for one-command autonomous planning, batch execution, and reporting with candidate-summary session artifacts
...
- Implemented the portrait-oriented junior-demographer follow-up UX pass in the Projection Observatory dashboard: automatic portrait layout detection, a vertically ordered Command Center with first-run onboarding/session outcome priority, verdict-first Decision Brief framing with sticky next-step navigation, portrait-friendly projection/sensitivity summaries in front of raw tables, and placeholder-based handling for empty chart states instead of blank plot shells.
- Implemented the junior-ready first-run hardening pass in the Projection Observatory dashboard and launcher: workstation preflight before full dashboard render, dedicated readiness screen for missing dependencies/shared-data blockers, canonical workspace-state resolution shared by the launcher/data manager/decision brief/command center, a top-level `Guided` versus `Explore Directly` mode switch, outcome-driven route cards in Command Center, recommendation-package preparation for strong benchmark-backed candidates, and stricter archive semantics so missing `index.csv` or zero complete bundles no longer surface as review-ready evidence.
- Implemented the operational-quality decision follow-on for the Projection Observatory and benchmark evaluator: `artifact_completeness_flag`, `runtime_summary_present`, `reproducibility_logging_flag`, and archive-relative runtime thresholds now participate in experiment classification, search/session decision summaries, benchmark decision briefs, CLI `status`, and recommendation readiness; incomplete or unusable benchmark evidence now classifies as `inconclusive`, while reproducibility/runtime warnings force review instead of recommendation prep.
- Implemented the SOP-003 latest-pointer convenience layer and history smoke tests: `scripts/analysis/refresh_latest_benchmark_pointers.py` now rebuilds alias-aligned symlink views under `data/analysis/benchmark_history/latest/`, `scripts/analysis/promote_method.py` refreshes the affected alias automatically after promotion (and after `--revalidate` when used), and regression tests now verify the disposable pointer layer does not modify canonical dated run bundles, `index.csv`, or `promotion_history.csv`.

Incremental follow-ups on 2026-03-21:

- Replaced the preset-first autonomous-search path with a first-class deep-search control plane: shared CPU allocator, adaptive replanning loop, CF-001 search pack loading, append-only session journaling, quarantine handling for operational blockers, and deterministic frontier/brief artifacts (`frontier.csv`, `deep_search_brief.json/.md`).
- Added `deep-search` as the canonical end-to-end CLI entrypoint while keeping `search-auto` as a backward-compatible alias, and extended `search-plan` so deep-search sessions can be planned with explicit CPU budgets, search packs, time budgets, and optional AI synthesis flags.
- Updated the dashboard Command Center so the default user path is now `CPU cores -> Begin Deep Search`, with pack/time/AI controls moved under collapsed Expert Controls and completed-session previews reading the new Deep Search Brief artifacts.
- Added optional claim-checked AI synthesis scaffolding (`ai_synthesis.py`) that can narrate deterministic evidence only when explicitly enabled/configured, and otherwise falls back to the deterministic brief.
- Hardened benchmark/run artifact reliability by making benchmark `run_id`s collision-resistant under parallel launch, surfacing the shared CPU allocation policy in both CLI and dashboard flows, and classifying orchestration/bundle defects as quarantined `operational_blocker` evidence instead of analytical model results.

## PP-007 Projection Observatory Operational Hardening (Canonical)

### Owner Goal

The target operating mode for the Projection Observatory is not just human-assisted review. The owner wants it to be a system they can "let loose on many variants and trust the search loop" to run a large number of experiments, compare them coherently, and identify the best methods to promote or implement.
...
- `OBS-01` completed. Comparator ranking, Pareto analysis, and summaries now operate on a canonical candidate view with explicit `config_id` → `run_id` fallback policy, deduplicating repeated baseline/champion rows across benchmark bundles.
- `OBS-02` completed. Recommender boundary/interaction/plateau heuristics now only use gate-clean runs (`champion` or `passed_all_gates`), with an explicit policy note in formatted output.
...
- Follow-up UX closure: `OBS-UX-09` and `OBS-UX-10` landed on 2026-03-15. `Scorecards`, `Projections`, and `Horizon & Bias` now preserve shortlist context through shared dashboard state, and the Experiment Tracker tables now emphasize readable labels/action columns over internal implementation fields.
...
| Step ID | Task | Status | Definition of Done | Evidence Target |
|------|------|------|------|------|
| OBS-01 | Candidate identity normalization | completed_2026-03-13 | Rankings, Pareto frontier, and summaries deduplicate repeated champion/baseline rows and operate on a clean candidate view (`run_id`/`config_id` policy explicitly documented) | Comparator output + tests |
| OBS-02 | Gate-aware recommendation policy | completed_2026-03-13 | Recommender filters or downweights unresolved / failed / review-only runs using explicit policy rules before surfacing next experiments | Recommender tests + policy note |
...
1. OBS-01 through OBS-05 first.
   - These are trust and correctness prerequisites.
   - Do not treat the Observatory as a reliable autonomous search loop before these are closed.

2. OBS-06 through OBS-08 second.
   - These are operational hardening items for larger unattended sweeps.

3. OBS-09 last.
   - Write the operator workflow after the actual system behavior is stabilized.

### Session Handling Rule For Agents
...
| WS-A-06 | Production run | completed_2026-03-01 | Rolling-Origin Backtests | 4 expanding windows, B-I winner (mean=2.5858) marginally over B-II (2.6645); spread 0.079 confirms variant equivalence; B-II retained for boundary behavior | `data/backtesting/rolling_origin_results/rolling_origin_winner.json` |
...
| WS-A-08 | Methodology docs | completed_2026-03-01 | Rolling-Origin Backtests | Added §7.5.1 rolling-origin cross-validation subsection with results table and ADR-057 reference | `docs/methodology.md` |
...
| WS-B-08 | Validation run | completed_2026-03-01 | Multi-County Splitting | 7 multicounty places validated; 62 year-level roundtrip tests all pass with zero error; allocation weights normalized and non-negative | `data/backtesting/multicounty_validation_results.txt`, `scripts/validation/validate_multicounty_splitting.py` |
...
| WS-C-08 | Production run | completed_2026-03-01 | TIGER/Geo Exports | 42 GeoJSON files generated (7 years × 2 geo levels × 3 scenarios); 53 county + 90 place features per file; population totals match known projections | `data/exports/*/county/geojson/`, `data/exports/*/place/geojson/`, `data/projections/exports/geojson/` |
...
| WS-D-11 | Workbook integration | completed_2026-03-01 | Housing-Unit Method | HU Comparison sheet added (optional); 18 HIGH+MODERATE places compared; 2 new tests; workbook 22 sheets with HU data, 21 without | `scripts/exports/build_place_workbook.py`, `tests/test_output/test_place_workbook.py` |
...
- `pytest tests/ -q --rootdir=. --no-cov -k "not test_residual_computation_single_period"` -> `1570 passed, 5 skipped, 1 deselected`
...
- **WS-A**: 34 tests, 98% coverage, ADR-057 Accepted; production backtest: 4 windows, B-I winner (mean=2.5858) marginally over B-II (2.6645), spread 0.079 confirms equivalence
- **WS-B**: 38 tests, 88.6% coverage, ADR-058 Accepted; validation: 7 places, 62 roundtrip tests, zero error
- **WS-C**: 23 tests (18 unit + 5 integration), ADR-059 Accepted; production: 42 GeoJSON files, population totals verified
- **WS-D**: 32+2 tests (27+2 unit + 5 integration), 93.6% coverage, ADR-060 Accepted; ACS data fetched (6,003 rows, 406 places, 15 vintages); HU projections run; workbook HU Comparison sheet operational
- **All deferred items completed**: WS-A-06, WS-A-08, WS-B-08, WS-C-08, WS-D-11
...
| PP3-S02 | Historical place data readiness | completed_2026-02-28 | Verify place-level annual history coverage needed for backtesting (target window: 2000-2024) and identify any gaps requiring imputation or exclusion rules | `docs/reviews/audit/2026-02-28-place-data-readiness-note.md` |
| PP3-S03 | Place-to-county boundary mapping strategy | completed_2026-02-28 | Define authoritative mapping and handling rules for boundary/vintage changes so place shares can be compared consistently over time | `docs/reviews/analysis/2026-02-28-place-county-mapping-strategy-note.md` |
| PP3-S04 | Modeling spec for share-trending | completed_2026-02-28 | Select candidate trend specifications and constraint approach (share sum <= 100%, balance-of-county handling) for Phase 1 testing | `docs/reviews/analysis/2026-02-28-pp3-s04-modeling-spec.md` |
| PP3-S05 | Backtesting design and metrics | completed_2026-02-28 | Lock backtest design (train/test windows) and acceptance metrics by confidence tier | `docs/reviews/analysis/2026-02-28-pp3-s05-backtesting-design.md` |
| PP3-S06 | Output contract | completed_2026-02-28 | Define Phase 1 deliverables: projection files, metadata fields, QA summary tables, and workbook impacts | `docs/reviews/analysis/2026-02-28-pp3-s06-output-contract.md` |
| PP3-S07 | Approval gate (required) | approved_2026-02-28 | Human approval recorded to proceed from scoping to implementation (Tier 3 methodology-change control) | `docs/reviews/analysis/2026-02-28-pp3-s07-approval-gate.md` |
...
| IMP-09 | Backtest execution + variant selection | completed_2026-02-28 | Ran ND production backtest matrix and produced S05 artifacts; winner selected `B-II` (`wls` + `cap_and_redistribute`, score `3.0757840903894844`). Primary scored tiers all PASS; secondary window HIGH tier flagged FAIL (diagnostic) | `scripts/backtesting/run_place_backtest.py`, `data/backtesting/place_backtest_results/backtest_summary_primary.csv`, `data/backtesting/place_backtest_results/backtest_summary_secondary.csv`, `data/backtesting/place_backtest_results/backtest_per_place_detail.csv`, `data/backtesting/place_backtest_results/backtest_variant_scores.csv`, `data/backtesting/place_backtest_results/backtest_prediction_intervals.csv`, `data/backtesting/place_backtest_results/backtest_winner.json`, `docs/reviews/benchmarking/2026-02-28-pp3-imp09-backtest-results.md` |
| IMP-10 | Outlier narrative + structural-break documentation | completed_2026-03-01 | Human review completed: accepted winner adoption, approved Horace/Williston structural-break interpretations (annexation and oil-economy fluctuation), approved progression to pipeline integration with no diagnostic exclusions applied | `docs/reviews/analysis/pp3-backtest-outlier-narrative.md` |
| IMP-11 | Place projection pipeline stage integration | completed_2026-03-01 | Added `02a_run_place_projections.py` stage, wired into `run_complete_pipeline.sh`, validated via integration tests and executed full stage run across active scenarios (`baseline`, `restricted_growth`, `high_growth`) with per-scenario outputs produced | `scripts/pipeline/02a_run_place_projections.py`, `scripts/pipeline/run_complete_pipeline.sh`, `tests/test_integration/test_place_pipeline_stage.py`, `docs/reviews/benchmarking/2026-03-01-pp3-imp11-pipeline-stage-results.md` |
| IMP-12 | QA artifact generation | completed_2026-03-01 | Implemented S06 Section 5 QA artifact pipeline at `data/projections/{scenario}/place/qa/` (`qa_tier_summary.csv`, `qa_share_sum_validation.csv`, `qa_outlier_flags.csv`, `qa_balance_of_county.csv`) with schema checks and outlier flag-type validation; human review gate approved with notes | `cohort_projections/data/process/place_projection_orchestrator.py`, `tests/test_data/test_place_qa_artifacts.py`, `docs/reviews/benchmarking/2026-03-01-pp3-imp12-imp13-results.md`, `docs/reviews/benchmarking/2026-03-01-pp3-imp12-imp13-approval-gate.md` |
| IMP-13 | Consistency constraint enforcement | completed_2026-03-01 | Enforced S06 hard constraints (share bounds, county share sum, place<=county totals, non-negative populations, exact output universe, state-level scenario ordering when all scenario county outputs are available) and soft QA signaling (balance warning, share-stability flags, tier-band extreme growth flags); human review gate approved with notes | `cohort_projections/data/process/place_projection_orchestrator.py`, `tests/test_data/test_place_consistency_constraints.py`, `docs/reviews/benchmarking/2026-03-01-pp3-imp12-imp13-results.md`, `docs/reviews/benchmarking/2026-03-01-pp3-imp12-imp13-approval-gate.md` |
| IMP-13A | Reconciliation magnitude QA (Gate 4) | completed_2026-03-01 | Added `qa_reconciliation_magnitude.csv` county-year artifact (`total_before_adjustment`, `total_after_adjustment`, `reconciliation_adjustment`, threshold flag fields), integrated Gate 4 magnitude distribution + top-adjustment table in human review package, and added invariant-style tests | `cohort_projections/data/process/place_projection_orchestrator.py`, `scripts/reviews/build_pp3_human_review_package.py`, `tests/test_data/test_place_qa_artifacts.py`, `docs/reviews/benchmarking/2026-03-01-pp3-imp13a-results.md`, `docs/reviews/analysis/2026-03-01-pp3-gate4-rescaling-review-note.md` |
| IMP-14 | Place workbook builder | completed_2026-03-01 | Added standalone place workbook builder per S06 Section 7.2 with required 21-sheet structure (TOC + 9 HIGH + 9 MODERATE + combined LOWER + Methodology), key-year age/sex tables, LOWER-tier uncertainty caveat header, TOC hyperlinks, and place-specific methodology text | `scripts/exports/build_place_workbook.py`, `scripts/exports/_methodology.py`, `tests/test_output/test_place_workbook.py`, `docs/reviews/benchmarking/2026-03-01-pp3-imp14-results.md` |
| IMP-15 | Provisional workbook update (`Places` sheets) | completed_2026-03-01 | Added `Places — {scenario_short}` sheets to the provisional workbook for all active scenarios with place + balance rows, county/tier labels, key-year populations, and growth-rate columns while preserving legacy county/state sheet structure | `scripts/exports/build_provisional_workbook.py`, `tests/test_output/test_provisional_workbook_places.py`, `docs/reviews/benchmarking/2026-03-01-pp3-imp15-results.md` |
| IMP-16 | Export pipeline `--places` flag wiring | completed_2026-03-01 | Wired `--places` in `scripts/pipeline/03_export_results.py` to emit place export artifacts (summary CSV + workbook), covered `--all` inclusion, and enforced dry-run no-file behavior via integration tests | `scripts/pipeline/03_export_results.py`, `tests/test_integration/test_export_places.py`, `docs/reviews/benchmarking/2026-03-01-pp3-imp16-results.md` |
| IMP-17 | Methodology text update | completed_2026-03-01 | Added place-specific methodology text in shared export constants and expanded `docs/methodology.md` Section 7.5 with explicit share-of-county specification, winner variant (`B-II`), tier thresholds, county constraint, and QA artifact coverage (human wording/tone sign-off pending) | `scripts/exports/_methodology.py`, `docs/methodology.md`, `tests/test_output/test_place_workbook.py`, `docs/reviews/benchmarking/2026-03-01-pp3-imp17-imp18-results.md` |
| IMP-18 | Integration tests | completed_2026-03-01 | Added synthetic end-to-end integration test running stage + export entrypoints with real orchestrator path, validating place constraints/QA artifacts and workbook export outputs | `tests/test_integration/test_place_projection_integration.py`, `docs/reviews/benchmarking/2026-03-01-pp3-imp17-imp18-results.md` |
| IMP-19 | End-to-end validation (full active-scenario run) | approved_2026-03-01 | Executed full place pipeline for `baseline`, `restricted_growth`, and `high_growth`; all IMP-19 checks PASS (`90` place outputs/scenario, hard constraints PASS, QA artifact set complete, scenario ordering PASS, workbooks generated, metadata/summary counts verified, place totals constrained to county totals); human sign-off gate approved | `docs/reviews/analysis/pp3-end-to-end-validation.md`, `docs/reviews/benchmarking/2026-03-01-pp3-imp19-approval-gate.md` |
| IMP-20 | ADR-033 status update | completed_2026-03-01 | ADR-033 status changed to `Accepted` with implemented date and full implementation-results section (winner metrics, IMP-19 validation summary, structural-break disposition, evidence links), and ADR index status/counts updated accordingly | `docs/governance/adrs/033-city-level-projection-methodology.md`, `docs/governance/adrs/README.md`, `docs/reviews/analysis/2026-03-01-pp3-imp20-results.md` |
| IMP-21 | Publication-facing methodology finalization consistency | completed_2026-03-01 | Finalized publication-facing place methodology wording across `docs/methodology.md`, export constants, and place-workbook methodology output dependency coverage; aligned language to ADR-033 accepted/implemented state plus IMP-19/IMP-20 evidence | `docs/methodology.md`, `scripts/exports/_methodology.py`, `tests/test_output/test_place_workbook.py`, `docs/reviews/analysis/2026-03-01-pp3-imp21-methodology-finalization-consistency-results.md` |
| IMP-22 | DEVELOPMENT_TRACKER closeout update | completed_2026-03-01 | Updated tracker and evidence links to final IMP-21/IMP-22 artifacts, removed superseded draft references, and confirmed PP-003 closeout state | `DEVELOPMENT_TRACKER.md`, `docs/reviews/analysis/2026-03-01-pp3-imp22-tracker-closeout-results.md`, `docs/reviews/benchmarking/2026-03-01-pp3-imp19-approval-gate.md`, `docs/reviews/analysis/2026-03-01-pp3-imp20-results.md`, `docs/reviews/analysis/2026-03-01-pp3-imp21-methodology-finalization-consistency-results.md` |
...
- Human review approvals recorded in `docs/reviews/analysis/pp3-backtest-outlier-narrative.md`:
...
- IMP-09 review checklist updated to completed in `docs/reviews/benchmarking/2026-02-28-pp3-imp09-backtest-results.md`.
...
- Human gate approvals recorded in `docs/reviews/benchmarking/2026-03-01-pp3-imp12-imp13-approval-gate.md`: overall **Approved with notes**; Gates 1/2/3/7/8 approved; Gates 4/5/6 approved with notes.
...
- `source .venv/bin/activate && pytest tests/test_output/test_place_workbook.py tests/test_integration/test_place_projection_integration.py` -> `2 passed`.
- `docs/reviews/analysis/pp3-end-to-end-validation.md` records full IMP-19 gate-check matrix and metric snapshot:
...
- Human sign-off gate disposition: `docs/reviews/benchmarking/2026-03-01-pp3-imp19-approval-gate.md` -> **Approved**.
...
- `docs/reviews/analysis/2026-03-01-pp3-imp20-results.md` records IMP-20 execution summary and evidence links.
...
| DOC-002 | 2026-02-23 projection output review "minor issues" may be stale | closed_2026-02-28 | Completed: revalidation recorded in-place; both minor issues are now explicitly marked resolved/stale | `docs/reviews/analysis/2026-02-23-projection-output-review.md` |
...
- `docs/reviews/audit/2026-03-01-publication-output-signoff.md`
- `docs/reviews/audit/2026-02-28-publication-output-qa-packaging-checklist.md`
- `docs/reviews/audit/2026-02-28-place-data-readiness-note.md`
- `docs/reviews/analysis/2026-02-28-place-county-mapping-strategy-note.md`
- `docs/reviews/analysis/2026-02-28-pp3-s04-modeling-spec.md`
- `docs/reviews/analysis/2026-02-28-pp3-s05-backtesting-design.md`
- `docs/reviews/analysis/2026-02-28-pp3-s06-output-contract.md`
- `docs/reviews/analysis/2026-02-28-pp3-s07-approval-gate.md`
...
- `docs/reviews/benchmarking/2026-03-01-pp3-imp11-pipeline-stage-results.md`
- `docs/reviews/benchmarking/2026-03-01-pp3-imp12-imp13-results.md`
- `docs/reviews/benchmarking/2026-03-01-pp3-imp12-imp13-approval-gate.md`
- `docs/reviews/benchmarking/2026-03-01-pp3-imp13a-results.md`
- `docs/reviews/benchmarking/2026-03-01-pp3-imp14-results.md`
- `docs/reviews/benchmarking/2026-03-01-pp3-imp15-results.md`
- `docs/reviews/benchmarking/2026-03-01-pp3-imp16-results.md`
- `docs/reviews/benchmarking/2026-03-01-pp3-imp17-imp18-results.md`
...
- `docs/reviews/analysis/2026-03-01-pp3-imp21-methodology-finalization-consistency-results.md`
- `docs/reviews/analysis/2026-03-01-pp3-imp22-tracker-closeout-results.md`

...
| PUB-2026 | Public projection release handoff to marketing | active | Marketing intake begins 2026-05-27. ADR-065 accepted: public release is baseline-only with CBO-adjusted assumptions in `baseline`; `recent_trend_continuation`, `restricted_growth`, and `high_growth` are inactive/internal. ADR-066 accepted: production base-population totals now use Census PEP Vintage 2025 `CO-EST2025-ALLDATA` (`POPESTIMATE2025`; North Dakota total 799,358) rather than the stale legacy 2024 county CSV. Next milestone is final-number production during the week of 2026-06-01 after CF-001 is resolved and the ADR-065/066 baseline production rerun passes QA. Public package excludes city/place projections and uses consolidated Excel/CSV downloads. | `docs/plans/2026-public-projection-release-handoff/`, ADR-065, ADR-066, ADR-042, ADR-038, CF-001 |

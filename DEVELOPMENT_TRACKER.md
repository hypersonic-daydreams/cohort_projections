...
| Public projection handoff | active | PUB-2026 opened on 2026-05-27 for marketing intake and public PDF/download planning. ADR-065 now defines the public path as Baseline (CBO-Adjusted), with the CBO additive migration adjustment and -5% fertility adjustment embedded in `baseline`. Public scope remains state/region/county only, no city/place publication, and one consolidated public Excel plus one consolidated CSV. Existing March 2026 draft numbers/assets are stale for final copy; final numbers are targeted for the week of 2026-06-01 after CF-001 disposition and an ADR-065 baseline rerun. |
...
| PUB-2026 | Public projection release handoff to marketing | active | Marketing intake begins 2026-05-27. ADR-065 accepted: public release is baseline-only with CBO-adjusted assumptions in `baseline`; `recent_trend_continuation`, `restricted_growth`, and `high_growth` are inactive/internal. Next milestone is final-number production during the week of 2026-06-01 after CF-001 is resolved and the ADR-065 baseline production rerun passes QA. Public package excludes city/place projections and uses consolidated Excel/CSV downloads. | `docs/plans/2026-public-projection-release-handoff/`, ADR-065, ADR-042, ADR-038, CF-001 |

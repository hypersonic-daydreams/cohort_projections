...
| PUB-2026-ERRATA | Pre-handoff errata + assessment follow-ups (2026-07-06 draft-materials review vs 2024 SDC report) | open | Fix stale "37 of 53" declining-county count in public copy — locked CSV says **36** (F1); verify-or-reword the 2018 "~0.7%" track-record claim — printed 2024-PDF numbers imply ~1.85% (F2); fix pyramid 90+ labels — PNGs say "90-94", workbook chart-pyramid sheets emit duplicate "85+" rows (F3); regenerate gitignored workbook + reference PDF after bisync on the handoff machine (F4); refresh stale handoff-folder front-door README / provisional snapshot (F5); extend `_check_prose_sync` token coverage (I6). Content upgrades pending owner selection: 2024-comparison box (I1), components-of-change exhibit (I2), region key-year table (I3), explainer packaging (I4), PDF-copy prose pass (I5). | `docs/reviews/audit/2026-07-06-pub-2026-draft-materials-assessment.md` |

#!/usr/bin/env python3
"""
Run all three SDC 2024 methodology variants and compare results.
...
def main():
    ...
    print("=" * 60)
    print("SDC 2024 Methodology: Three-Variant Comparison")
    print("=" * 60)
    ...
    if UPDATED_DATA_DIR.exists() and (UPDATED_DATA_DIR / "base_population_by_county.csv").exists():
    ...
    if POLICY_DATA_DIR.exists() and (POLICY_DATA_DIR / "base_population_by_county.csv").exists():

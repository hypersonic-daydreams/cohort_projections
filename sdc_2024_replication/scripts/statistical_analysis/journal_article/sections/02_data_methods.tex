...
The analysis draws on four primary data sources, each capturing distinct dimensions of international migration to North Dakota. Table~\ref{tab:data_sources} summarizes the coverage, geographic scope, and key variables from each source.
...
\begin{tabular}{@{}llll@{}}
\toprule
\textbf{Source} & \textbf{Time Period} & \textbf{Geographic Scope} & \textbf{Key Variables} \\
\midrule
Census PEP & 2010--2024 & 50 states + DC & Net international migration \\
DHS LPR & FY 2023 & State $\times$ country & LPR admissions by origin \\
ACS Foreign-Born & 2009--2023 & State $\times$ country & Foreign-born population stock \\
Refugee Arrivals & 2002--2020 & State $\times$ nationality & Refugee resettlement counts \\
\bottomrule
\end{tabular}
\end{table}

...
Second, while RPC refugee arrivals are available beyond fiscal year 2020, some post-2020 archive reports omit states in specific years, producing incomplete state panels (ADR-025). Analyses that require a balanced state$\times$nationality panel (e.g., wave duration across states) therefore restrict to FY2002--FY2020, while North Dakota-focused and national descriptive series can use the extended FY2021--FY2024 window where available.

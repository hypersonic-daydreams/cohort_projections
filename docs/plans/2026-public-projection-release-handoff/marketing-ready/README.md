...
- CF-001 was disposed on 2026-06-11 (ADR-061 Accepted as modified; ADR-067
  ...
  satisfied; the data package (`drafts/`) is regenerated by rerunning
  [`scripts/exports/build_public_draft_package.py`](../../../../scripts/exports/build_public_draft_package.py).
- The narrative Word documents (`PUB-2026 *.docx`) are **generated, not
  hand-edited** — they are built from the locked markdown sources
  (`draft-public-pdf-copy.md`, `pdf-content-outline.md`, `2024-sdc-pdf-review.md`,
  this README) and the locked CSV by
  [`scripts/exports/build_marketing_docx.py`](../../../../scripts/exports/build_marketing_docx.py).
  Edit the markdown source and rerun the generator rather than editing the
  `.docx` directly, so the Word files cannot drift from the locked numbers again.

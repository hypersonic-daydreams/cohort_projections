...
(the control checklist this signs off), [2026-06-13-locked-run-sanity-check.md](../analysis/2026-06-13-locked-run-sanity-check.md)
...
| 1b — Demographic Plausibility | **PASS** | [Sanity check](../analysis/2026-06-13-locked-run-sanity-check.md): aggregation exact, components reconcile, dip = CBO, age/sex plausible, 53-county scan coherent, divergent counties dispositioned. |

...
| **Bottom-up state aggregation** | State = county sum | `docs/reviews/analysis/2026-06-13-locked-run-sanity-check.md`: max abs diff `0.0000`; ADR-054 | **Yes** | Strong. I did not receive aggregation code, but validation evidence is direct. |
